...
\begin{minipage}[t]{0.2\textwidth}
    ...
    \begin{tabular}{r @{\hspace{0.5em}}l}
	    \textbf{Python} & \pictofraction{\faCircle}{cvred}{5}{black!30}{1}{\tiny} \\
	    \textbf{Shell} & \pictofraction{\faCircle}{cvred}{4}{black!30}{2}{\tiny} \\
 	    \textbf{LaTeX} & \pictofraction{\faCircle}{cvgreen}{4}{black!30}{2}{\tiny} \\
	    \textbf{Matlab} & \pictofraction{\faCircle}{cvgreen}{2}{black!30}{4}{\tiny} \\
		\textbf{R} & \pictofraction{\faCircle}{cvgreen}{3}{black!30}{3}{\tiny} \\
...
\begin{tabular}{r| p{0.6\textwidth} c}
    ...
    \textbf{Representative Courses:} Hydrology, Physical Geography, Histrocial Geography, et al. 
...
%Some of my researches are highly related to socio-hydrology quantitative analysis are shown below, some of which have not been published. Perhaps they can be used as pieces of evidence that I can achieve the research plan in my proposal:
